  ...
  return (
    <Box className="grid grid-cols-4 gap-x-5">
      ...
      <Box key={event.key} className="relative h-[760px]">
        <Image className="absolute z-0 w-full h-full" fill src={event.asset} alt="event-bg"/>
        <Box className="absolute w-full h-full flex justify-center items-end pb-16">
          ...
          <Typography variant="h2" className="text-white text-center">{event.title}</Typography>
